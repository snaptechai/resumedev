            ...
            <form action="{{ route('seo-tags.update', $seoTag->id) }}" method="POST" class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div class="space-y-4 bg-gray-50 p-5 rounded-lg">
                        ...
                        <div>
                            <label for="page_name" class="block text-sm font-medium text-gray-700 mb-1">Page Name <span
                                    class="text-red-500">*</span></label>
                            <input type="text" id="page_name" name="page_name"
                                value="{{ old('page_name', $seoTag->page_name) }}" required
                        ...
                        <div>
                            <label for="meta_title" class="block text-sm font-medium text-gray-700 mb-1">Meta Title
                                <span class="text-red-500">*</span></label>
                            <input type="text" id="meta_title" name="meta_title"
                                value="{{ old('meta_title', $seoTag->meta_title) }}" required
                                class="w-full rounded-lg border-gray-300 py-2 px-3 text-gray-700 focus:ring-2 focus:ring-[#BCEC88] focus:border-[#BCEC88] border">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="meta_keywords" name="meta_keywords" rows="3" required
                                class="w-full rounded-lg border-gray-300 py-2 px-3 text-gray-700 focus:ring-2 focus:ring-[#BCEC88] focus:border-[#BCEC88] border"
                                placeholder="Enter keywords separated by commas">{{ old('meta_keywords', $seoTag->meta_keywords) }}</textarea>
                            <p class="mt-2 text-sm text-gray-500">
                    ...
                    <div class="space-y-4 bg-gray-50 p-5 rounded-lg">
                        ...
                        <div>
                            <label for="javascript_code" class="block text-sm font-medium text-gray-700 mb-1">JavaScript
                                Code</label>
                            <textarea id="javascript_code" name="javascript_code" rows="15"
                                class="w-full rounded-lg border-gray-300 py-2 px-3 text-gray-700 focus:ring-2 focus:ring-[#BCEC88] focus:border-[#BCEC88] border">{{ old('javascript_code', $seoTag->javascript_code) }}</textarea>
                        </div>
