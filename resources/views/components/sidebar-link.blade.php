...
@php
    $classes =
        $active ?? false
            ? 'flex items-center gap-4 px-4 py-2 rounded-radius bg-primary/10 font-medium text-sm text-on-surface-strong underline-offset-2 focus:outline-hidden focus:underline dark:bg-primary-dark/10 dark:text-on-surface-dark-strong'
