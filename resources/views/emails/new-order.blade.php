                    ...
                    <tr>
                        <td class="content" style="padding: 0 30px 30px;">
                            ...
                            <div class="normal-text">
                                    <p>We would like to inform you that a new order has been placed on the platform and requires your attention.</p>
                                    ...
                                    <p>Please log in to the admin panel to review the order details and proceed with the necessary steps, such as writer assignment, quality check, or tracking progress</p>
