                    ...
                    <tr>
                        <td class="content" style="padding: 0 30px 30px;">
                            ...
                            <div class="normal-text">
                                ...
                                writer. To keep things seamless, we’ve synced this message
                                with your email as well.
                            </div>

                            <div class="message-box">
                                <div class="message-header">Message Preview:</div>
                            ...
                            <div class="normal-text">
                                For the full conversation and next steps, log in to your
                                account or continue here:
                            </div>

                            <div class="login-link">
                                <a href="https://resumemansion.com">
                                    Log in to Resume Mansion
                                </a>
                            </div>

                            <div class="normal-text">
                                Feel free to reply directly to this email or via chat—we’ll
                                ensure your feedback is captured no matter the channel.
                            </div>
