                    ...
                    <tr>
                        <td class="content" style="padding: 0 30px 30px;">
                            ...
                            <div class="normal-text">
                                    ...
                                    <p>This is to inform you that a new order has been assigned to you. Please find the order details below:</p>
                                    <ul>
                                    <li>
                                        <span class="highlight">Package:</span> 
                                        {{ $data['order']->package->title }}
                                        @foreach ($data['order']->package->addon as $addon)
                                            + {{ $addon->title }}
                                        @endforeach
                                    </li>

                                    <li><span class="highlight">Order ID:</span> #{{ 'RM' . sprintf('%06d', $data['order']->id) }}</li>
                                    <li><span class="highlight">End Date:</span> {{ $data['order']->end_date }}</li>
                                    </ul>

                                    <p>Kindly review the order at your earliest convenience and begin working on it as soon as possible to ensure timely delivery. If you have any questions or concerns regarding the order, please don’t hesitate to reach out.</p>
                                        
                                    <p>Thank you for your continued dedication and quality work.</p>

                                    <p>Stay tuned for updates!</p></div>
