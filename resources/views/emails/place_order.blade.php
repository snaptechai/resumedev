                    ...
                    <tr>
                        <td class="content" style="padding: 0 30px 30px;">
                            ...
                            <div class="normal-text">
                                    <p>Thank you for placing your order with <strong>Resume Mansion</strong>! We’re excited to help you take your career to the next level.</p>
                                    ...
                                    <p>To get started, please submit the required information so we can craft a document that perfectly aligns with your career goals.</p>

                                    <p>Our team will begin processing your request shortly. If you have any questions or need to provide additional information, feel free to contact us.</p>
