                    ...
                    <tr>
                        <td class="content" style="padding: 0 30px 30px;">
                            ...
                            <div class="normal-text">
                                We’re excited to let you know that your order is ready!
                            </div>

                            <div class="normal-text">
                                Please check the attached file to review your order.
                            </div>

                            <div class="normal-text">
                                If you have any questions or need adjustments, let us know within 10 days of
                                delivery.
                            </div>

                            <div class="normal-text">
                                Thank you for choosing Resume Mansion to support your career growth!
                            </div>
